...
HD_PWD='C:/Vivado/FPGA/lab_Practise_PYNQ/misc_0/calcFinal/calcFinal.runs/design_1_parent_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_parent_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_parent_0_0.tcl
