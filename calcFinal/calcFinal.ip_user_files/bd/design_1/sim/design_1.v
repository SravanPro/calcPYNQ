...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=6,numReposBlks=6,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=2,da_board_cnt=1,da_ps7_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  wire done_0;
  wire [4:0]encodedRawInput_0;
  wire [319:0]parent_0_axiOut;
  ...
  design_1_dataBridgeIP_0_0 dataBridgeIP_0
       (.fpgaIn(parent_0_axiOut),
  ...
  design_1_parent_0_0 parent_0
       (.axiOut(parent_0_axiOut),
        .clockIn(processing_system7_0_FCLK_CLK0),
        .done(done_0),
        .encodedRawInput(encodedRawInput_0),
        .reset(reset_0));
