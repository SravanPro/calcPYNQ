...
REM
REM Generated by Vivado on Wed Mar 25 23:10:30 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj newTB_trig_vlog.prj"
call xvlog  --incr --relax -L uvm -prj newTB_trig_vlog.prj -log xvlog.log
