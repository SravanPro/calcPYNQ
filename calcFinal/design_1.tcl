...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
xilinx.com:user:dataBridgeIP:1.0\
xilinx.com:ip:processing_system7:5.5\
xilinx.com:ip:smartconnect:1.0\
xilinx.com:ip:proc_sys_reset:5.0\
xilinx.com:user:parent:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set encodedRawInput_0 [ create_bd_port -dir I -from 4 -to 0 encodedRawInput_0 ]
  ...
  # Create instance: dataBridgeIP_0, and set properties
  set dataBridgeIP_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:dataBridgeIP:1.0 dataBridgeIP_0 ]
...
\
  ...
  # Create instance: parent_0, and set properties
  set parent_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:parent:1.0 parent_0 ]
  ...
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins dataBridgeIP_0/S00_AXI]
  ...
  connect_bd_net -net encodedRawInput_0_1  [get_bd_ports encodedRawInput_0] \
  [get_bd_pins parent_0/encodedRawInput]
  connect_bd_net -net parent_0_axiOut  [get_bd_pins parent_0/axiOut] \
  [get_bd_pins dataBridgeIP_0/fpgaIn]
  connect_bd_net -net parent_0_done  [get_bd_pins parent_0/done] \
  [get_bd_ports done_0]
  connect_bd_net -net processing_system7_0_FCLK_CLK0  [get_bd_pins processing_system7_0/FCLK_CLK0] \
  [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] \
  [get_bd_pins axi_smc/aclk] \
  [get_bd_pins dataBridgeIP_0/s00_axi_aclk] \
  [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] \
  [get_bd_pins axi_iic_0/s_axi_aclk] \
  [get_bd_pins parent_0/clockIn]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N  [get_bd_pins processing_system7_0/FCLK_RESET0_N] \
  [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net reset_0_1  [get_bd_ports reset_0] \
  [get_bd_pins parent_0/reset]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn  [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] \
  [get_bd_pins dataBridgeIP_0/s00_axi_aresetn] \
  ...
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs dataBridgeIP_0/S00_AXI/S00_AXI_reg] -force
